...
import com.example.googleadmanagerrecyclerviewexample.extension.loremIpsum
import java.util.*

data class FeedModel(val id: String, val title: String, val imageUrl: String, val width: Int, val height: Int):
    FeedItem {
